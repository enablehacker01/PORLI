...
echo " |                      JAKARTA SELATAN\                       |" | lolcat
echo " | NIK              : 3216061106980033                         |" | lolcat
echo " | Nama             : ADE CALVIN ARDIANSYAH                    |" | lolcat
echo " | Tempat/tgl.Lahir : BEKASI,11-06-2=1998                      |" | lolcat
echo " | Alamat           : KP KEDUNG GEDE NO 92                     |" | lolcat
echo " | RT/RW            : 002/015                                  |" | lolcat
echo " | Kel/desa         : SETIA MEKAR                              |" | lolcat
echo " | Kecamatan        : TAMBUN SELATAN                           |" | lolcat
echo " | Agama            : ISLAM                                    |" | lolcat
echo " | Status           : Belum Kawin                              |" | lolcat
